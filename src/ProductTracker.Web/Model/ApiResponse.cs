...
public class ApiResponse
{
    ...
    /// <summary>
    /// Конструктор класса <see cref="ApiResponse"/>
    /// </summary>
    public ApiResponse() { }
    ...
    /// Конструктор класса <see cref="ApiResponse" />
    /// </summary>
    /// <param name="success">Статус сообщения.</param>
    /// <param name="successMessage">Текст сообщения при успехе.</param>
    /// <param name="statusCode">Код ответа.</param>
    /// <param name="errors">Ошибки приложения.</param>
    [JsonConstructor]
    ...
    public override string ToString() =>
        $"Статус: {Success} | Ответ: {StatusCode} | HasErrors: {Errors.Any()}";
}
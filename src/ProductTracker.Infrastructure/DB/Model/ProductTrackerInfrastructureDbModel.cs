...
namespace DataModel
{
	public partial class ProductTrackerInfrastructureDbModel : DataConnection
	{
		public ProductTrackerInfrastructureDbModel()
		{
			InitDataContext();
		}

		public ProductTrackerInfrastructureDbModel(string configuration)
			: base(configuration)
		{
			InitDataContext();
		}

		public ProductTrackerInfrastructureDbModel(DataOptions<ProductTrackerInfrastructureDbModel> options)
